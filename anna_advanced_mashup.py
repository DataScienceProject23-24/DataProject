...
from Handler import  Handler, MetadataUploadHandler, ProcessDataUploadHandler, MetadataQueryHandler, ProcessDataQueryHandler
from DataModelClasses import IdentifiableEntity, CulturalHeritageObject, NauticalChart, ManuscriptPlate, ManuscriptVolume, PrintedVolume, PrintedMaterial, Herbarium, Specimen, Painting, Model, Map, Acquisition, Processing, Modelling, Optimising, Exporting
...
class AdvancedMashup(BasicMashup):
    ...
    def getObjectsHandledByResponsiblePerson(self, name): #works but need to change id
    ...
    def getObjectsHandledByResponsibleInstitution(self, institution): #works but need to change id
...
data2.setDbPathOrUrl("http://10.201.6.172:9999/blazegraph/sparql")
data2.pushDataToDb("meta.csv")

metadata_query_handler = MetadataQueryHandler()
metadata_query_handler.setDbPathOrUrl("http://10.201.6.172:9999/blazegraph/sparql") 
...
#pprint(resultlist)
print(advanced_mashup.getActivitiesByResponsibleInstitution('Philology'))

mash_try = advanced_mashup.getObjectsHandledByResponsibleInstitution("Council")
#pprint(mash_try)
