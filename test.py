...
from DataModelClasses import Person, CulturalHeritageObject, Activity, Acquisition
...
class TestProjectBasic(unittest.TestCase):
    ...
    metadata = r"C:\Users\user\Documents\GitHub\DataProject\meta.csv"
    process = r"C:\Users\user\Documents\GitHub\DataProject\process.json"
    relational = r"C:\Users\user\Documents\GitHub\DataProject\activities.db"
